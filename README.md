...
### NOTE1 : The ordering of the scenes are: Main Menu and then SampleScene.
Leaderboard Scene can be accessed from any of the scenes. By clicking on leaderboards on main menu, or by dying.

### NOTE2: The PowerPoint presentation is in the presentation folder. It is available as a .pptx and a .pdf
